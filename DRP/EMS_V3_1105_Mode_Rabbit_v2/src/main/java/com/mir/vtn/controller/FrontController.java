...
public class FrontController {
	...
	enum EventDetails {
		venID, dtstart_str, duration, market_context_id, priority, response_required_type_id, vtn_comment, test_event,
		signal_name_id, signal_type_id, payload_value
	}
	...
	@PostMapping("/events")
	public ResponseEntity<Object> createStudent(@RequestBody byte[] payload)
...
//	public  void changeRegisteredVenSeqNum(EventDetail eventDetail) {
	...
	public static void changeRegisteredVenSeqNum(EventDetail eventDetail) {
