...
public class policyTopology2 extends JPanel {
	public static int flag = 0;

	Graph graph = new SingleGraph("Tutorial 1");
	public final String emsEdge = "REST_EMS";

	public policyTopology2() {
		/*
		 * Graph Layout Setting
		 */
		java.net.URL emsUrl = policyTopology2.class.getResource("/IMAGE/dddd.png");
	...
	public void createTopology() {
		java.net.URL gatewayUrl = policyTopology2.class.getResource("/IMAGE/GATEWAYICONS.png");
		java.net.URL ledUrl = policyTopology2.class.getResource("/IMAGE/GATEWAYICONS.png");
		java.net.URL deviceURL = policyTopology2.class.getResource("/IMAGE/LED.png");
