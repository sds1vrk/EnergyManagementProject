...
//	public List<Double> yData = new ArrayList<Double>();
	...
	public CopyOnWriteArrayList<Date> xData = new CopyOnWriteArrayList<Date>();

	public CopyOnWriteArrayList<Double> yData = new CopyOnWriteArrayList<Double>();


	Object[][] arr = new Object[3][2];

	public CopyOnWriteArrayList<Double> zData1 = new CopyOnWriteArrayList<Double>();
	
//	public List<Double> zData1 = new ArrayList<Double>();

	public HashMap<String, List<Double>> yVal = new HashMap<String, List<Double>>();

	public final int emaNum= 3;
	public static final String SERIES_NAME = "SERVER_EMA1";
	public static final String SERIES_NAME2 = "SERVER_EMA2";
	public static final String SERIES_NAME3 = "SERVER_EMA3";
...
//		timer.
	...
	private CopyOnWriteArrayList<Date> getCurrentTime() {
		CopyOnWriteArrayList<Date> data = new CopyOnWriteArrayList<Date>();
